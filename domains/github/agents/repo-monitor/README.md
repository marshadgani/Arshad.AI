...
**Domain:** `github`
**Branch:** `agent/github/repo-monitor`

## Purpose

Watches repo events (pushes, PRs, CI status) and alerts Arshad
...
```
POST /api/v1/github/repo-monitor/<action>
```
...
- All code changes for this agent live on `agent/github/repo-monitor` only
