...
**Domain:** `ai-core`
**Branch:** `agent/ai-core/chat-orchestrator`

## Purpose

Routes user messages to appropriate domain agents via the API gateway
...
```
POST /api/v1/ai-core/chat-orchestrator/<action>
```
...
- All code changes for this agent live on `agent/ai-core/chat-orchestrator` only
