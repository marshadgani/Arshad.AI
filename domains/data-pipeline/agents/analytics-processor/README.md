...
**Branch:** `agent/data-pipeline/analytics-processor`

## Purpose

Aggregates ingested data into summary tables for the dashboard
...
```
POST /api/v1/data-pipeline/analytics-processor/<action>
```
...
- All code changes for this agent live on `agent/data-pipeline/analytics-processor` only
