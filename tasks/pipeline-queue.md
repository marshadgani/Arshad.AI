...
| Field | Value |
|---|---|
| active_run_id | none — `wf_738cf4b2-26a` settled 2026-09-14 (halted) |
| session | session_014myBCLtbRkzEMbxbxJsCrq |
| started | 2026-09-14 |
| FEAT-141 (Obsidian ontology layer, retry) | Settled 2026-09-14, halted — Architecture Critic blocked after 2 redesign iterations. Notably caught a real recurrence of SEC-001 (NULL-laundering reopens the visibility ratchet) before any code was written. See Queue table row for full detail. |
