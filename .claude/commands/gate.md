...
Orchestrates all 6 review agents in parallel, compiles a master report,
...
All 6 agents approved this change.
...
mcp__github__merge_pull_request(
  ...
  commitMessage="Merged via Arshad.AI Quality Gate — all 6 agents passed."
)
```
